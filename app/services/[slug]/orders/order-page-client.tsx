// app/services/[slug]/orders/order-page-client.tsx
'use client';
...
import { Minus, Plus, ShoppingCart, ArrowLeft, Check, Clock, Shield, Truck, Leaf, AlertCircle, Phone, MessageCircle, Trash2, MapPin, X, ShoppingBag } from 'lucide-react';
import { toast } from 'sonner';
import type { Service, ServiceItem } from './page';
...
export default function OrderPageClient({ slug, initialService, initialServiceItems, initialError }: Props) {
    const router = useRouter();
    const { addToCart, cartItems = [], updateQuantity, removeFromCart, clearCart } = useCart();
    const { sessionId } = useSession();

    // Seeded from the server — the page already has real content on first paint.
                                        ...
                                        <div className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-xl">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">Please select if there is requirement our team will contact you shortly</p>
                                                </div>
                                            </div>
                                            <button
